...
class View
{
    ...
    protected $_returnNoController = false;
    ...
    public function render($action = null , $noController = NULL, $hanveParam = false)
    {
        if ($hanveParam) {
            $action = $this->_returnAction;
            $noController = $this->_returnNoController;
        }
    ...
    public function setReturnAction($name = '')
    {
        $this->_returnAction = $name;
    }

    public function setReturnNoController($noController = false)
    {
        $this->_returnNoController = $noController;
    }
